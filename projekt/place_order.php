...
// Uberpr�fung, ob der Benutzer eingeloggt ist
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Berechnungen f�r zus?tzliche Anzahl und Preis
    ...
    try {
        // Rechnung in die Tabelle 'rechnung' einf�gen
        ...
        // Artikel in die Tabelle 'artikel' einf�gen (ohne Preis)
        ...
        // Rechnung Details in die Tabelle 'rechnung_details' einf�gen (mit Preis)
...
<head>
    ...
    <link rel="stylesheet" href="styles_order_confirmation.css"> <!-- ???? ???? CSS ????? ????? ??????? -->
</head>
<body>
